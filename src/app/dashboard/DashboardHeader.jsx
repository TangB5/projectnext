...
export default function DashboardHeader({
    ...
    // Nom d'utilisateur à afficher (utilise session.user.name ou une valeur par défaut)
    ...
    // Rendu du titre dynamique
    const getTitle = () => {
        switch (activeTab) {
            case 'dashboard-home': return "Tableau de bord";
            case 'products-management': return "Gestion des produits";
            case 'orders-management': return "Commandes";
            case 'customers-management': return "Clients";
