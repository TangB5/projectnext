        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 max-w-4xl mx-auto">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-emerald-100 text-center transition-all hover:shadow-md hover:-translate-y-1 hover:bg-emerald-50">
              <div className="text-3xl font-bold text-emerald-700 mb-2">150+</div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-emerald-100 text-center transition-all hover:shadow-md hover:-translate-y-1 hover:bg-emerald-50">
              <div className="text-3xl font-bold text-emerald-700 mb-2">24h</div>
          ...
          <div className="flex items-center justify-center mb-16">
            <div className="h-1 w-20 bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-full"></div>
            <div className="h-1 w-6 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full mx-2"></div>
            <div className="h-1 w-20 bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-full"></div>
          </div>
